...
const About = () => {
    ...
    return (
        <div id='about'>
            <header id="header">
                <h1 className="logo">
                    <Link to="/home" className='goMain' prefetch="true">Y<span className='split aboutLogo'>unYoungsik</span></Link>
                </h1>
                <div className="aboutClose goMain">
                    <Link to="/home" className="underline" prefetch="true">Close</Link>
                </div>
            </header>
            <main id='main'>
                <div className="aboutSlideWrap">
                    ...
                    <div className="aboutInfor">
                        <div className="aboutInfor__left">
                            ...
                            <p className='desc'>
                                디자인에서 웹 개발로의 전환을 통해 창의적인 디자인 아이디어와 프론트엔드 역량을 결합하며, 사용자들에게 더 나은 웹 경험을 선사하는 것을 즐기는 열정적인 프론트엔드 개발자입니다.
                            </p>
                        </div>
